...
const TradeForm: FC = () => {
  ...
  return (
    <>
      <div className="flex lg:w-1/4 xl:w-1/5 lg:border-[1px] lg:border-gray-700">

        <form className="w-full flex flex-col items-center text-white " onSubmit={handleSubmit}>
          ...
          <label className="trade-label flex items-center px-5 py-4 mt-4">
            <input type="text" className="trade-input text-center w-full" placeholder="Title" />
          </label>

          <label className="trade-label flex items-center px-5 py-4 mt-4">
            <p className="text-gray-400">Amount</p>
            <input type="text" className="trade-input text-right pr-4 w-full" />
            <p>EUR</p>
          </label>
